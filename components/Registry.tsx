  ...
  return (
    <>
      ...
      <div className="bg-gray-50 min-h-full">
        <Header
          subtitle={name === "std" ? "Librairie Standard" : "Module Tier"}
          widerContent={true}
        />
              ...
              if (versions === null) {
                ...
                return (
                  <ErrorMessage
                    ...
                    body={`Ce nom de module a été réservé pour un dépôt, mais aucune version n'a encore été publiée. Les modules qui ne publient pas une version dans les 30 jours suivant leur enregistrement seront supprimés. ${
                      versions.isLegacy
                        ? "Si vous êtes le propriétaire de ce module, veuillez ré-ajouter le dépôt GitHub avec deno.land/x (en suivant les instructions sur https://deno.land/x#add), et publier une nouvelle version."
                        : ""
                    }`}
                  />
                );
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    ...
                    {(() => {
                      if (
                        ...
                        return (
                          <ErrorMessage
                            title="404 - Non trouvé"
                            body="Cette version n'existe pas pour ce module."
                          />
                        );
                      } else if (
                        versionMeta &&
                        ...
                        return (
                          <ErrorMessage
                            title="404 - Non trouvé"
                            body="Ce fichier ou répertoire n'a pas pu être trouvé."
                          />
                        );
                  ...
                  <div className="col-span-1 row-start-1 md:row-start-auto flex flex-col sm:flex-row md:flex-col gap-4">
                    ...
                    <div className="max-w-sm w-full shadow-sm rounded-lg border border-gray-200 p-4">
                      <p className="text-md font-semibold mb-2">Informations sur la version</p>
                      {versionMeta === undefined ? (
                        <div className="mt-2 flex items-center py-0.5">
                          <svg
                            className="h-5 w-5 mr-2 inline text-gray-200"
